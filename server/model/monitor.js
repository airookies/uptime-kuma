            ...
            try {
                if (await Monitor.isUnderMaintenance(this.id)) {
                    ...
                    if (children.length > 0) {
                        bean.status = UP;
                        bean.msg =
                            "すべてのプロセスが稼働中です / All children up and running";
                        ...
                        if (bean.status !== UP) {
                            bean.msg =
                                "AI モデルサーバーにアクセスできません / Child inaccessible";
                        }
                    } else {
                        // Set status pending if group is empty
                        bean.status = PENDING;
                        bean.msg = "グループが空です / Group empty";
                    }
                } else if (
                    this.type === "http" ||
                    this.type === "keyword" ||
                    ...
                    if (this.type === "http") {
                        ...
                        if (keywordFound === !this.isInvertKeyword()) {
                            bean.msg += keywordFound
                                ? ", プロセスは正常に実行されています / keyword is found"
                                : ",プロセスが停止しました / keyword is not found";
                            // bean.msg +=
                            //     ", keyword " +
                            //     (keywordFound ? "is" : "not") +
                            //     " found";
